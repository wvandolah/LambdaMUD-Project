...
* Request:  (Replace token string with logged in user's auth token)
  * `curl -X GET -H 'Authorization: Token 54eb2614b189b9693b4dc66a8e3fdd53373d3980' localhost:8000/api/adv/init/`
* Response:
...
### Move
* Request:  (Replace token string with logged in user's auth token)
  * `curl -X POST -H 'Authorization: Token 54eb2614b189b9693b4dc66a8e3fdd53373d3980' -H "Content-Type: application/json" -d '{"direction":"n"}' localhost:8000/api/adv/move/`
* Response:
...
* Request:  (Replace token string with logged in user's auth token)
  * `curl -X POST -H 'Authorization: Token 54eb2614b189b9693b4dc66a8e3fdd53373d3980' -H "Content-Type: application/json" -d '{"message":"Hello, world!"}' localhost:8000/api/adv/say/`
* Pusher broadcast:
